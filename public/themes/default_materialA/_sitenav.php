...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
            ...
            <div class="info-container">
                ...
                <div class="btn-group user-helper-dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <li>
                            <a href="<?php echo site_url('users/profile'); ?>" class=" waves-effect waves-block">
                        ...
                        <!-- <li><a href="javascript:void(0);" class=" waves-effect waves-block"><i class="material-icons">group</i>Followers</a></li>
                            ...
                            <li role="seperator" class="divider"></li>-->
                        <li>
                            <a href="<?php echo site_url('logout'); ?>" class=" waves-effect waves-block">
        ...
        <!-- Menu -->
        <div class="menu">
            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 385px;">
                <ul class="list" style="overflow: hidden; width: auto; height: 385px;">
                ...
                <div class="slimScrollBar" style="background: rgba(0, 0, 0, 0.5); width: 4px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 0px; z-index: 99; right: 1px; height: 159.382px;"></div>
