...
<nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand muted" href="<?php echo site_url(); ?>"><?php e(class_exists('Settings_lib') ? settings_item('site.title') : 'Bonfire'); ?></a>
                <a href="javascript:void(0);" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse" aria-expanded="false"></a>
            </div>
            <div class="collapse navbar-collapse "  id="navbar-collapse">
         <!--       <ul class="nav nav-pills pull-right navbar-nav navbar-right list">-->
  ...
  <!-- #Top Bar -->
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="<?php echo images_path(); ?>user.png" width="48" height="48" alt="User" />
